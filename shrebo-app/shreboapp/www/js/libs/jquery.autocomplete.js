/**
 * Ajax Autocomplete for jQuery, version %version% (c) 2014 Tomas Kirda
 * 
...
(function(factory) {
    ...
    (function($) {
        ...
        Autocomplete.prototype = {
            ...
            initialize : function() {
                var that = this, suggestionSelector = '.'
                    + that.classes.suggestion, selected = that.classes.selected, options = that.options, container;
                ...
                that.suggestionsContainer = Autocomplete.utils
                    .createNode(options.containerClass);
            ...
            setOptions : function(suppliedOptions) {
                ...
                if (that.isLocal) {
                    options.lookup = that
                        .verifySuggestionsFormat(options.lookup);
                }

                options.orientation = that
                    .validateOrientation(options.orientation, 'bottom');
            ...
            fixPosition : function() {
                ...
                var that = this, $container = $(that.suggestionsContainer), containerParent = $container
                    .parent().get(0);
                ...
                // Choose orientation
                var orientation = that.options.orientation, containerHeight = $container
                    .outerHeight(), height = that.el.outerHeight(), offset = that.el
                    .offset(), styles = {
                    'top' : offset.top,
                    'left' : offset.left
                };
                ...
                if (orientation === 'auto') {
                    var viewPortHeight = $(window).height(), scrollTop = $(window)
                        .scrollTop(), topOverflow = -scrollTop + offset.top
                        - containerHeight, bottomOverflow = scrollTop
                        + viewPortHeight
            ...
            onKeyPress : function(e) {
                ...
                // display suggestions:
                if (!that.disabled && !that.visible && e.which === keys.DOWN
                    && that.currentValue) {
                    that.suggest();
                    return;
                }
            ...
            onValueChange : function() {
                var that = this, options = that.options, value = that.el.val(), query = that
                    .getQuery(value), index;

                if (that.selection && that.currentValue !== query) {
                    that.selection = null;
                    (options.onInvalidateSelection || $.noop)
                        .call(that.element);
                }
            ...
            findSuggestionIndex : function(query) {
                var that = this, index = -1, queryLowerCase = query
                    .toLowerCase();
            ...
            getSuggestionsLocal : function(query) {
                var that = this, options = that.options, queryLowerCase = query
                    .toLowerCase(), filter = options.lookupFilter, limit = parseInt(options.lookupLimit, 10), data;
            ...
            getSuggestions : function(q) {
                ...
                if ($.isFunction(options.lookup)) {
                    options.lookup(q, function(data) {
                        ...
                        options.onSearchComplete
                            .call(that.element, q, data.suggestions);
                    });
                    return;
                }
                ...
                if (response && $.isArray(response.suggestions)) {
                    ...
                    that.suggest();
                    options.onSearchComplete
                        .call(that.element, q, response.suggestions);
                    ...
                    that.currentRequest = $
                        ...
                        .done(function(data) {
                            ...
                            options.onSearchComplete
                                .call(that.element, q, result.suggestions);
                        })
                        .fail(function(jqXHR, textStatus, errorThrown) {
                            options.onSearchError
                                .call(that.element, q, jqXHR, textStatus, errorThrown);
                        });
                } else {
            ...
            hide : function() {
                var that = this;
                //** miraculixx: backport from https://github.com/devbridge/jQuery-Autocomplete/commit/a2c472853b17cabea33b9a05aac30897e39e19d6 
            ...
            suggest : function() {
                ...
                var that = this, options = that.options, groupBy = options.groupBy, formatResult = options.formatResult, value = that
                    .getQuery(that.currentValue), className = that.classes.suggestion, classSelected = that.classes.selected, container = $(that.suggestionsContainer), noSuggestionsContainer = $(that.noSuggestionsContainer), beforeRender = options.beforeRender, html = '', category, formatGroup = function(suggestion, index) {
                    ...
                    return '<div class="autocomplete-group"><strong>'
                        + category + '</strong></div>';
                }, index;
                ...
                $.each(that.suggestions, function(i, suggestion) {
                    ...
                    html += '<div class="' + className + '" data-index="' + i
                        + '">' + formatResult(suggestion, value) + '</div>';
                });
            ...
            findBestHint : function() {
                ...
                $.each(that.suggestions, function(i, suggestion) {
                    var foundMatch = suggestion.value.toLowerCase()
                        .indexOf(value) === 0;
                    if (foundMatch) {
            ...
            processResponse : function(result, originalQuery, cacheKey) {
                ...
                result.suggestions = that
                    .verifySuggestionsFormat(result.suggestions);
            ...
            moveUp : function() {
                ...
                if (that.selectedIndex === 0) {
                    $(that.suggestionsContainer).children().first()
            ...
            adjustScroll : function(index) {
                ...
                var offsetTop, upperBound, lowerBound, heightDelta = $(activeItem)
                    .outerHeight();
        ...
        $.fn.autocomplete = $.fn.devbridgeAutocomplete = function(options, args) {
            ...
            return this.each(function() {
                var inputElement = $(this), instance = inputElement
                    .data(dataKey);
